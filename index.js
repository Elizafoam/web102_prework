...
const displayStr = unfundedCount == totalGames ?  `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames-unfundedCount} games. All games have been funded! Thank you for your help funding these amazing games! ` : `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames- unfundedCount} games. Currently, ${unfundedCount} games remain unfunded. We need your help to fund these amazing games!`
